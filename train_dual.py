...
import configepoch
import getEpoch
from shared_epoch import set_epoch
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        # print(f'params:{params}, GFLOPS:{2*flops}')
        LOGGER.info('params:%.2f M, GFLOPS:%.1f B'%(params / 1e6, 2 * flops / 1e9))
        configepoch.training_state.epoch = epoch
